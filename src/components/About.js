...
const About = () => {
    return (
        <ThemeContainer>
            ...
            <Typography>You can check out some of the additional intereactivity you can get working with technology such as React in my demo.</Typography>
            <Typography>I'm also friendly and approachable so do get in touch if you have a project we could work together on.</Typography>
        </ThemeContainer>
    )
}
