...
const About = () => {
    return (
        <ThemeContainer>
            ...
            <Typography>
                I build sites and web apps using the tools that best meet the customer's need. But I like to work with React, Redux, Gatsby and the headless CMS approach, where clients get to edit their content using a familiar platform such as WordPress but the front end of the site is delivered via the super fast <a href="https://jamstack.org/">JAMStack</a>.
            </Typography>
            <Typography>You can check out some of the additional interactivity you can get from technology such as React in <Link to='/demo'>my demo</Link>.</Typography>
